...
--
-- >>> pure (+10) <*> ExactlyOne 8
-- >>> ExactlyOne (+10) <*> ExactlyOne 8
-- >>> ExactlyOne (+10) <*> pure 8
-- ExactlyOne 18
...
lift2 ::
  ...
  -> k c
lift2 f a b =
  f <$> a <*> b -- VERY USEFUL !!! first map(Functor), then apply(Applicative)
...
filtering ::
  ...
  -> k (List a)
filtering p =
  foldRight (\a -> lift2 (\b -> if b then (a:.) else id) (p a)) (pure Nil) -- TODO: double check this
